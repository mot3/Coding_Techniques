...
// You decide to create a new class called Queue2,
// which is derived from the Queue class and overrides the print() method, outputting each element of the queue on a new line.
